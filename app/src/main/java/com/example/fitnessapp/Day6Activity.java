    ...
    private void compute(){
        switch (action){
            ...
            case 8:
                ...
                break;
            case 9:
                Intent intent9 = new Intent(getApplicationContext(),SquatActivity.class);
                startActivity(intent9);
                break;
            case 10:
                Intent intent10 = new Intent(getApplicationContext(),PushupActivity.class);
                startActivity(intent10);
                break;
            case 11:
                Intent intent11 = new Intent(getApplicationContext(),WalkinglungeActivity.class);
