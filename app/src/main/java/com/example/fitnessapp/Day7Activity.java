...
public class Day7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button start10 = findViewById(R.id.start10);
        Button start11 = findViewById(R.id.start11);
        Button start12 = findViewById(R.id.start12);
    ...
    private void compute(){
        switch (action){
            ...
            case 8:
                ...
                break;
            case 9:
                Intent intent9 = new Intent(getApplicationContext(),GetupsquatActivity.class);
                startActivity(intent9);
                break;
            case 10:
                Intent intent10 = new Intent(getApplicationContext(),SupermanActivity.class);
                startActivity(intent10);
                break;
            case 11:
                Intent intent11 = new Intent(getApplicationContext(),KneelingsideplankActivity.class);
                startActivity(intent11);
                break;
            case 12:
                Intent intent12 = new Intent(getApplicationContext(),WallsquatActivity.class);
