    ...
    private void compute(){
        switch (action){
            ...
            case 8:
                ...
                break;
            case 9:
                Intent intent9 = new Intent(getApplicationContext(),SlhaActivity.class);
                startActivity(intent9);
                break;
            case 10:
                Intent intent10 = new Intent(getApplicationContext(),BicyclecrunchActivity.class);
                startActivity(intent10);
                break;
            case 11:
                Intent intent11 = new Intent(getApplicationContext(),WallsquatActivity.class);
